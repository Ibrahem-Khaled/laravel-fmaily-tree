...
class QuizQuestionsSheet implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    public function map($question): array
    {
        ...
        $typeLabel = match ($question->answer_type) {
            'multiple_choice' => 'اختيار من متعدد',
            'ordering' => 'ترتيب',
            'true_false' => 'صح/خطأ',
            'vote' => 'تصويت',
            'fill_blank' => 'أملأ الفراغ',
            'survey' => 'استبيان ديناميكي',
            default => 'إجابة حرة',
        };
