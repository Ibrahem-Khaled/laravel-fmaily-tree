    ...
    <div class="card section-card">
        ...
        <div class="collapse" id="addImageForm">
            <div class="form-section">
                ...
                <form action="{{ route('dashboard.proud-of.media.store', $item) }}" method="POST" enctype="multipart/form-data" id="galleryUploadForm">
                    @csrf
        ...
        <div class="card-body">
            @if($galleryMedia->isEmpty())
                <div class="empty-state">
                    ...
                    <p class="text-muted">ابدأ برفع صور جديدة للعنصر</p>
                </div>
            @else
                        ...
                        <div class="media-card" data-id="{{ $media->id }}">
                            ...
                            <div class="p-3">
                                ...
                                <div class="action-buttons">
                                    ...
                                    <form action="{{ route('dashboard.proud-of.media.destroy', [$item, $media]) }}" 
                                          method="POST" 
