    ...
    <div class="card section-card">
        ...
        <div class="collapse" id="addGalleryForm">
            <div class="form-section">
                ...
                <form action="{{ route('dashboard.proud-of.galleries.store', $item) }}" method="POST">
                    @csrf
                            ...
                            <div class="gallery-card">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <form action="{{ route('dashboard.proud-of.galleries.destroy', [$item, $gallery]) }}" 
                                              method="POST" 
                                ...
                                <div class="collapse mt-2" id="addGalleryMediaForm{{ $gallery->id }}">
                                    <form action="{{ route('dashboard.proud-of.galleries.media.store', [$item, $gallery]) }}" 
                                          method="POST" 
                                            ...
                                            @foreach($gallery->images as $image)
                                                <div class="list-group-item d-flex justify-content-between align-items-center p-2 border-0">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="{{ route('dashboard.proud-of.galleries.media.destroy', [$item, $gallery, $image]) }}" 
                                                              method="POST" 
