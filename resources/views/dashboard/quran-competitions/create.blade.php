...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0">قم بإضافة مسابقة جديدة لحفظ القرآن الكريم</p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('dashboard.quran-competitions.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('hijri_year') is-invalid @enderror" id="hijri_year" name="hijri_year" value="{{ old('hijri_year') }}" placeholder="مثال: 1445" required>
                            @error('hijri_year')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
