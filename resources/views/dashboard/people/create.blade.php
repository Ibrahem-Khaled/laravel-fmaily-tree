...
@section('title', 'إضافة شخص')

@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">إضافة شخص جديد</h1>
            <a href="{{ route('people.index') }}" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-right"></i> رجوع لقائمة الأشخاص
            </a>
        </div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">إضافة شخص</li>
            </ol>
        </nav>
        ...
        <form action="{{ route('people.store') }}" method="POST" enctype="multipart/form-data">
            ...
            @include('dashboard.people.partials.form', ['person' => null, 'males' => $males])

            <div class="d-flex justify-content-end">
                <a href="{{ route('people.index') }}" class="btn btn-secondary">إلغاء</a>
