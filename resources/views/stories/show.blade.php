    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="glass rounded-2xl p-6 md:p-8 shadow-md">
            @if($story->content)
                ...
                <p class="text-gray-800 whitespace-pre-line leading-8" style="text-rendering: optimizeLegibility; font-feature-settings: 'liga' 1, 'kern' 1; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">{{ $story->content }}</p>
                <hr class="my-6">
            @endif
