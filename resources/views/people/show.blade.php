        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 text-center">
                    <img src="{{ $person->avatar }}" alt="{{ $person->full_name }}" class="img-fluid rounded-circle mb-3"
                ...
                <div class="col-md-9">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>الأب</th>
                            <td>{{ $person->parent->full_name ?? 'غير معروف' }}</td>
                        </tr>
                        <tr>
                            <th>الأم</th>
                            <td>{{ $person->mother->full_name ?? 'غير معروف' }}</td>
                        </tr>
                        <tr>
                            <th>فترة الحياة</th>
                            <td>{{ $person->life_span ?? 'غير معروف' }} (العمر: {{ $person->age ?? 'غير معروف' }})</td>
                        </tr>
                        <tr>
                            <th>المهنة</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-circle btn-primary" data-toggle="modal"
                                    data-target="#editPersonModal{{ $spouse->id }}" title="تعديل">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="{{ $child->avatar }}" alt="{{ $child->full_name }}"
                                        class="rounded-circle mr-2" width="40" height="40">
                                    <a href="{{ route('people.show', $child->id) }}">{{ $child->full_name }}</a>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-circle btn-primary" data-toggle="modal"
                                    data-target="#editPersonModal{{ $child->id }}" title="تعديل">
                                    <i class="fas fa-edit"></i>
                                </button>
                            </td>
                        </tr>
...
@push('scripts')
<script>
    // Script لتحديث اسم الملف عند اختياره في مودالات التعديل
